...
module rv32i_cpu_formal #(
    ...
    // Formal-only debug ports: exposes internal signals for the pc_bind.sv
    // formal harness. Same-scope assigns (legal); never used by the real
    // CPU testbench or synthesis flow.
